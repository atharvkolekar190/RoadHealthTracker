        ...
        <div class="container1">
            ...
            <form class="form" action="/RHT2/" method="POST">
                <div class="input-group1">
                    ...
                    <input type="checkbox" onclick="myFunction()" style="width: 18px; height:18px;"> &nbsp;Show Password <!-- forgot password start --><span class="fp" id="forpas"><a href="/RHT2/forgotpassd.php"><span style="color:red;">Forgot Password?</span></a></span><!-- forgot password end -->
